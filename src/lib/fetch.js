...
const MAX_ENTRIES = 1500;                // bound memory (was 5000 — under AI-crawler load the cache of parsed JSON responses, keyed by highly-variable geocoder URLs, was a memory driver behind the ~every-few-min recycle)
 ...
 */
export async function fetchJSON(url, timeout = 4000) {
